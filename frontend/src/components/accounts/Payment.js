      ...
      <Fragment>
        <div className="premium__form">
          <div className="premium__details">
            <h2>
              {user.business.plan == "F"
                ? "Upgrading from Free Trial to Premium"
                : `Upgrading your Premium Plan`}
            </h2>
            <p>
              <strong>Number of employees:</strong> {total_employees}
            </p>
            <p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex-container--wrap">
              <Link to="/premium">
                <button className="btn-6--stretch">Back</button>
              </Link>

              <button
                type="submit"
                className={`btn-6--stretch ${
                  processing || loading.charge ? "processing" : ""
                }`}
              >
                Pay £{amount}
              </button>
