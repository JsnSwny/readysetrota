  ...
  return (
    <div className="wrapper--sm" style={{ marginTop: "40px" }}>
      ...
      <p>
        ...
        readysetrota and how we use it.
      </p>
      ...
      <p>
        readysetrota legal basis for collecting and using the personal
      ...
      <ul>
        <li>readysetrota needs to perform a contract with you</li>
        <li>You have given readysetrota permission to do so</li>
        <li>
          Processing your personal information is in readysetrota legitimate
          interests
        </li>
        <li>readysetrota needs to comply with the law</li>
      </ul>

      <p>
        readysetrota will retain your personal information only for as long as
      ...
      <p>
        readysetrota follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of readysetrota.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on readysetrota, which are sent
      ...
      <p>
        Note that readysetrota has no access to or control over these cookies
      ...
      <p>
        readysetrota's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        readysetrota does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in readysetrota. This policy is not applicable to
