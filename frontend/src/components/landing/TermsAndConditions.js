  ...
  return (
    <div className="wrapper--sm" style={{ marginTop: "40px" }}>
      ...
      <p>
        ...
        of readysetrota's Website, located at www.readysetrota.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use readysetrota if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing readysetrota, you agreed to
        use cookies in agreement with the readysetrota's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, readysetrota and/or its licensors own the
        intellectual property rights for all material on readysetrota. All
        intellectual property rights are reserved. You may access this from
        readysetrota for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from readysetrota</li>
        <li>Sell, rent or sub-license material from readysetrota</li>
        <li>Reproduce, duplicate or copy material from readysetrota</li>
        <li>Redistribute content from readysetrota</li>
      </ul>
      ...
      <p>
        ...
        readysetrota does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of readysetrota,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, readysetrota shall not be
      ...
      <p>
        readysetrota reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant readysetrota a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of readysetrota; and (d) the link
      ...
      <p>
        ...
        e-mail to readysetrota. Please include your name, your organization
      ...
      <p>
        No use of readysetrota's logo or other artwork will be allowed for
