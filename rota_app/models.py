...
class Shift(models.Model):
    ...
    department = models.ForeignKey(Department, related_name="shift_department", on_delete=models.SET_NULL, null=True, blank=True)
...
class TimeClock(models.Model):
    employee = models.ForeignKey(Employee, related_name="employee_timeclock", on_delete=models.CASCADE)
    clock_in = models.TimeField()
    clock_out = models.TimeField()

class Break(models.Model):
    timeclock = models.ForeignKey(TimeClock, related_name="timeclock_break", on_delete=models.CASCADE)
    start_time = models.TimeField()
